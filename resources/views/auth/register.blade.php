            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name_establishment" class="col-md-4 col-form-label text-md-right">{{ __('Establishment') }}</label>

                            <div class="col-md-6">
                                <input id="name_establishment" type="text" class="form-control @error('name_establishment') is-invalid @enderror" name="name_establishment" value="{{ old('name_establishment') }}" required autocomplete="name_establishment" autofocus>

                                @error('name_establishment')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
