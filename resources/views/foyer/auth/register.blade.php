    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('foyer.register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="name_res" class="col-md-4 col-form-label text-md-right">{{ __('Responsable Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="gouver" class="col-md-4 col-form-label text-md-right">{{ __('Government') }}</label>

                            <div class="col-md-6">
                                <input id="gouver" type="text" class="form-control @error('gouver') is-invalid @enderror" name="gouver" value="{{ old('gouver') }}" required autocomplete="gouver" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{route("foyer.login")}}" class="btn btn-outline-primary">
                                    {{ __('Login') }}
                                </a>
                            </div>
                        </div>
